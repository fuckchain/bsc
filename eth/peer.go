...
type ethPeerInfo struct {
	...
	BoundAt     int64    `json:"boundAt"`     // Time when the peer was bound, in milliseconds since Unix epoch
	TxSum       uint64   `json:"txSum"`       // Total number of transactions received
